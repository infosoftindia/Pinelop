...
$(function () {
	...
	// var productsJson = '{"products":[' +
		// '{"productId": 1,"productName":"dus","frontImgUrl":"img/tshirt1_front.jpg","backImgUrl":"img/tshirt1_back.jpg" },' +
		// '{"productId": 2,"productName":"John","frontImgUrl":"img/tshirt2_front.jpg","backImgUrl":"img/tshirt2_back.jpg" },' +
	...
	$('.design_area').css('background-image', 'url(' + front + ')');
	...
	function setProductModel(givenProducts) {
		...
		$(".product_details img").on("click", function (event) {
			...
			var slug = $(this).data("myval")
			location.href = base_url+'customize/'+slug;

			// proIdOfSelectedPro = parseInt($(this).attr("data-myval"), 10);
			// alert(proIdOfSelectedPro)
	...
	$(".back_btn").on("click", function () {
		...
		$('.design_area').css('background-image', 'url(' + back + ')');
	...
	function addDeleteBtn(x, y, w) {
		...
		$(".deleteBtn").on("click", function () {
			if (frontCanvas.getActiveGroup()) {
				frontCanvas.getActiveGroup().forEachObject(function (o) {
			...
			if (backCanvas.getActiveGroup()) {
				backCanvas.getActiveGroup().forEachObject(function (o) {
					backCanvas.remove(o);
				});
