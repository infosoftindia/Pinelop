						...
						<div class="col-lg-6 col-md-6">
							<div class="pr_detail">
								<div class="product_description">
									...
									<?php if($post['attributes']) { foreach($post['attributes'] as $attribute) { ?>
										...
										<div class="pr_switch_wrap">
											...
											<?php if($attribute['variables']){ foreach($attribute['variables'] as $variable){ ?>
										...
										<?php
											if($post['similars']){
												foreach($post['similars'] as $similar){
													echo '<div class="item">'.product_widget($similar['posts_id']).'</div>';
												}
											}
										?>
										</div>
