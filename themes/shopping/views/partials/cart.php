                        ...
                        <div class="cart_box dropdown-menu dropdown-menu-right">
                            <ul class="cart_list">
								...
								<li>
                                    ...
                                    <a href="<?=site_url('product/'.$cart['posts_slug'])?>"><img src="<?=base_url(getenv('uploads').$cart['posts_cover'])?>" alt="cart_thumb1"><?=$cart['posts_title']?></a>
                            ...
                            <div class="cart_footer">
								...
								<a href="<?=site_url('checkout')?>" class="btn btn-fill-out btn-radius checkout">Checkout</a></p>
                            </div>
                        </div>
						<?php } ?>