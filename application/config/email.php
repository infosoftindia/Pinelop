...
$config['smtp_host']        = getenv('MailServer');
...
$config['smtp_user']        = getenv('MailUser');
$config['smtp_pass']        = getenv('MailPassword');
$config['smtp_port']        = getenv('MailPort');
$config['smtp_timeout']     = 300;                       // (in seconds)
$config['smtp_crypto']      = getenv('MailCrypto');                       // '' or 'tls' or 'ssl'
