...
<div class="row gutters">
	<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
		<div class="card">
			<div class="card-header">Completed Payment</div>
			<div class="card-body">
						...
						<tr>
							...
							<td>
								<div class="btn-group " role="group">
									<button data-title="View Payment Data" data-href="<?=admin_url('payment/completed-edit/'.$payment['payments_id'])?>" class="btn btn-info" data-toggle="modal" data-target="#admin_model"><i class="icon-edit"></i></button>
								</div>
							</td>
						</tr>
					<?php } } ?>
