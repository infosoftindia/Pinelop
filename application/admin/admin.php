...
$route[$admin . 'products/brands'] = 'products/brands';
$route[$admin . 'products/edit-brand/(:num)'] = 'products/edit_brand/$1';
$route[$admin . 'products/delete-brand/(:num)'] = 'products/delete_brand/$1';
$route[$admin . 'products/edit/(:num)'] = 'products/edit/$1';
$route[$admin . 'products/delete/image/(:num)'] = 'products/edit_Image/$1';
...
$route[$admin . 'products/attribute/save-variant/(:num)'] = 'products/new_Variant/$1';
$route[$admin . 'products/attributes/delete-variant/(:num)'] = 'products/delete_Variant/$1';
