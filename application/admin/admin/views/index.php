...
<html lang="en">
	...
	<body class="login-bg">
					...
					<div class="login-container">
						<div class="row no-gutters">
							<div class="col-xl-4 col-lg-5 col-md-6 col-sm-12" id="section_admin_login">
								<form action="<?=site_url('admin/login_script')?>" method="POST">
									<div class="login-box">
										<a href="#" class="login-logo">
											<img src="./assets/img/unify.png" alt="iPatco" />
										</a>
										<?=alert('danger', 'error')?>
							...
							<div class="col-xl-4 col-lg-5 col-md-6 col-sm-12" id="section_forgot_password" style="display: none;">
								<form action="">
									<div class="login-box">
										<a href="#" class="login-logo">
											<img src="./assets/img/unify.png" alt="Pearl Organisation" />
										</a>
		...
		<footer class="main-footer no-bdr fixed-btm">
			<div class="container">
				Copyright &copy; <?=date('Y')?> <?=getenv('title')?>
			</div>
		</footer>
		<script>
