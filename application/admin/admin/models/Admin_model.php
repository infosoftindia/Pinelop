...
class Admin_model extends CI_Model
{
	...
	public function save_New_Vendor()
	{
		...
		$this->db->insert('vendors', [
			'vendors_user'		=> $id,
			'vendors_company'	=> $this->input->post('company'),
			'vendors_gst'		=> $this->input->post('gst'),
			'vendors_pan'		=> $this->input->post('pan'),
		]);
		return $id;
	}
	...
	{
		$this->db->where('activities_user', $this->session->userdata('user_id'));
