							...
							<tr>
								...
								<td>
									<div class="btn-group " role="group">
										<button data-title="View Campaign Data" data-href="<?=site_url('campaign/pending_view/'.$campaign['ads_id'])?>" class="btn btn-info" data-toggle="modal" data-target="#admin_model"><i class="icon-eye"></i></button>
									</div>
								</td>
							</tr>
						<?php } } ?>
