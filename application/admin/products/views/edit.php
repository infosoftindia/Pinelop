									...
									<select multiple="multiple" class="multiselect" name="similars[]">
										<?php if ($products) {
											foreach ($products as $similar) { ?>
												<option value="<?= $similar['posts_id'] ?>" <?= (in_array($similar['posts_id'], $product['similars'])) ? 'selected' : '' ?>><?= $similar['posts_title'] ?></option>
										<?php }
										} ?>
									</select>
								</div>
			...
			<div class="row gutters">
				...
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
					<div class="card">
						...
						<div class="card-body">
							<div class="form-group">
								<select class="form-control selectF" name="brand" style="width: 100%" required>
									<?php if ($brands) {
										foreach ($brands as $brand) { ?>
											<option value="<?= $brand['brands_id'] ?>"><?= $brand['brands_url'] ?></option>
									<?php }
									} ?>
								</select>
							</div>
