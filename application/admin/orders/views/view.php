										...
										<table class="table table-bordered">
											...
											<tbody>
												...
												<tr>
													...
													<td class="text-left">
														<a href="<?=base_url('product/'.$product['posts_slug'])?>" target="_blank"><?=$product['posts_title']?></a><br />
														<?php if(!empty($product['attributes'])){ foreach($product['attributes'] as $attribute){ ?>
