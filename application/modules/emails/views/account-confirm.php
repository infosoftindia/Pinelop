								...
								<tr>
									<td align="center" valign="top" width="600">
										...
										<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;" class="wrapper">
											...
											<tr>
												<td align="center" valign="bottom" style="font-size: 11px; font-family: Helvetica, Arial, sans-serif; color: #2C3E50;"> <?=getenv('title')?> </td>
											</tr>
											<tr>
												<td align="center" height="25" style="height:25px; font-size: 0;">&nbsp;</td>
											</tr>
											<tr>
												<td align="center"><a href="http://www.htmlemailcheck.com" title="Replace with your logo" target="_blank"> <img src="https://www.htmlemailcheck.com/assets/img/email/email-logo.jpg" width="66" height="79" alt="Replace with your logo" style="display: block; border:0; width:66px; height:79px;" border="0"> </a> </td>
											</tr>
											<tr>
												<td align="center" height="25" style="height:25px; font-size: 0;">&nbsp;</td>
											</tr>
														...
														<tr>
															<td>
																<table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
																	...
																	<tr>
																		<td align="left">
																			<h1 style="font-family: Helvetica, Arial, sans-serif; font-size: 28px; font-weight:normal; color: #2C3E50; margin:0; mso-line-height-rule:exactly;">Welcome to <?=getenv('title')?></h1>
																		</td>
																	</tr>
																	<tr>
																		<td align="center" height="25" style="height:25px; font-size: 0;">&nbsp;</td>
																	...
																	<tr>
																		<td align="left" style="font-family: Helvetica, Arial, sans-serif; font-size: 16px; line-height: 25px; color: #2C3E50;">Hey Prashant Rijal, <br><br>
																		It looks like you just signed up for <?=getenv('title')?>, that’s awesome! Can we ask you for email confirmation? Just click the button bellow.
																		</td>
																	</tr>
																</table>
															</td>
